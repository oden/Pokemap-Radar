...
RFMapObjectsManager *mapObjectManager;
...
- (void)getMapObjects {
    ...
    [mapObjectManager getMapObjectsWithCoordinate:[RFLocationManager instance].currentLocation.coordinate];
}
...
- (void)resetScan {
    [mapObjectManager resetPokemonScan];
}
